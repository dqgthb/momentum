...
if exist('crspWithMomentum.mat', 'file') %  check if mat file exists. If not, create a new one.
    ...
    % rank variable will be momentum for 12 months
    rankVariable = NaN(len,1); % create empty column
    % This forloop iterates and fill in the empty rankVariable vectors with
    % momentum of each date.
    n = 0;
    for i=1 : len
...
% Difference between momentum and momentum1000: momentum1000 comprises firms with top 1000 large Market Capitalization.
...
%%%%%%%%%% Data Analysis %%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
portReturns = array2table([momentum{:,6:end},momentum1000{:,6:end}]);
...
portReturns.Properties.VariableNames = portfolioNames;
% Cumulative Returns
